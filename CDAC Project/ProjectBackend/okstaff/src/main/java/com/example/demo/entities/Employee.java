...
public class Employee 
{
	...
	public String toString() {
		return "Employee [emp_id=" + emp_id + ", leavemaster=" + leavemaster + ", department=" + department
				+ ", emp_password=" + emp_password + ", emp_fname=" + emp_fname + ", emp_mname=" + emp_mname
				+ ", emp_lname=" + emp_lname + ", emp_contactno=" + emp_contactno + ", emp_emailid=" + emp_emailid
				+ ", emp_address=" + emp_address + ", emp_aadharcard=" + emp_aadharcard + ", emp_photo=" + emp_photo
				+ ", emp_dob=" + emp_dob + ", emp_doj=" + emp_doj + ", emp_auth_status=" + emp_auth_status
				+ ", emp_securityque=" + emp_securityque + ", emp_manager_id=" + emp_manager_id + "]";
	}
